...
for (j in 1:100){
  Y41[2] = 0.01 * j
  r41 = Y41[2] / 1
  temp41[j] = ratio_power(Y41, r41, 1, N, K, compute_pcombine, compute_power)
  temp42[j] = ratio_power(Y41, r41, 1, N, K, compute_pcombine, compute_power, ptype = "max")
  temp43[j] = ratio_power(Y41, r41, 1, N, K, compute_pcombine, compute_power, ptype = "median")
  temp44[j] = ratio_power(Y41, r41, 1, N, K, compute_pcombine, compute_power, ptype = "mean")
}

plot(seq(0.01,1,0.01), temp41, type = "l", xlab = "r1_value", ylab = "Power")
lines(seq(0.01,1,0.01), temp42, type = "l", col = "red")
lines(seq(0.01,1,0.01), temp43, type = "l", col = "blue")
lines(seq(0.01,1,0.01), temp44, type = "l", col = "green")
```
...
for (j in 1:d){
  Y51[2] <- Y51[2] + 1/d
  temp51[j] <- ratio_power(Y51, 0.01, 1, N, K, compute_pcombine, compute_power)
  temp52[j] <- ratio_power(Y51, 0.01, 1, N, K, compute_pcombine, compute_power, ptype = "max")
  temp53[j] <- ratio_power(Y51, 0.01, 1, N, K, compute_pcombine, compute_power, ptype = "median")
  temp54[j] <- ratio_power(Y51, 0.01, 1, N, K, compute_pcombine, compute_power, ptype = "mean")
}

plot(seq(0.01,1,0.01), temp51, type = "l", xlab = "Y1_value", ylab = "Power")
lines(seq(0.01,1,0.01), temp52, type = "l", col = "red")
lines(seq(0.01,1,0.01), temp53, type = "l", col = "blue")
lines(seq(0.01,1,0.01), temp54, type = "l", col = "green")
...
plot(seq(0.01,1,0.01), temp61, type = "l", xlab = "Y1_value", ylab = "Power")
lines(seq(0.01,1,0.01), temp62, type = "l", col = "red")
lines(seq(0.01,1,0.01), temp63, type = "l", col = "blue")
lines(seq(0.01,1,0.01), temp64, type = "l", col = "green")
