...
,main = "Power curve with different p-combined type given K = 2", col = "turquoise")
...
plot(seq(0.01,1,0.01), temp61, type = "l", xlab = "Y1_value", ylab = "Power",main = "Power curve with different p-combined type given K = 3", col = "turquoise")
...
plot(seq(0.01,1,0.01), temp21, type = "l", xlab = "Y1_value", ylab = "Power",main = "Power curve with different p-combined type given K = 50", col = "turquoise", knum = 10)
lines(seq(0.01,1,0.01), temp22, type = "l", col = "cornflowerblue", knum = 10)
lines(seq(0.01,1,0.01), temp23, type = "l", col = "deepskyblue", knum = 10)
lines(seq(0.01,1,0.01), temp24, type = "l", col = "navyblue", knum = 10)
...
plot(seq(0.01,1,0.01), temp31, type = "l", xlab = "Y1_value", ylab = "Power", main = "Power curve with different p-combined type given K = 100", col = "turquoise")
